...
function selectGameField(event){
    ...
    const selectedColumn = selectedField.dataset.col -1; // automatically contact string to number due to math operation "-"
...
function checkForGameOver(){
    ...
    if (gameData[2][0]>0 && gameData[2][0] === gameData[1][1] && gameData[1][1] === gameData[0][2]) return gameData[2][0];
